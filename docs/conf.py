...
release = pkg_resources.get_distribution("endaq-calc").version
...
html_theme_options = {
    "logo_link": "index",
    "github_url": "https://github.com/MideTechnology/endaq-python-calc",
...
latex_documents = [
    (master_doc, "enDAQ.tex", u"enDAQ Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "endaq-calc", u"enDAQ Documentation", [author], 1)]
